...
// Async Thunks
export const get_seller_payments = createAsyncThunk(
  "payment/get_seller_payments",
  async (sellerId, { rejectWithValue, fulfillWithValue }) => {
    try {
      const { data } = await api.get(`/payment/${sellerId}`, {
...
export const paymentReducer = createSlice({
  ...
  extraReducers: {
    [get_seller_payments.fulfilled]: (state, { payload }) => {
      state.sellerPayments = payload.payments;
    },
    // Handle other async actions and their state changes here
  },
});
